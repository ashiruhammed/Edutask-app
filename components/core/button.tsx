  ...
  return (
    <Button
      ...
      titleStyle={[
        ...
        props.type === 'solid' && {
          color:
            color && parseInt(color.replace('#', ''), 16) > 0xffffff / 1.1 ? colors.text : '#000',
        },
      ...
      buttonStyle={[
        ...
        props.type === 'solid' && { backgroundColor: color || colors.yellow[300] },
        props.type === 'outline' && { borderColor: color || colors.white },
        props.buttonStyle,
      ]}
      disabledTitleStyle={[
        // breaker
